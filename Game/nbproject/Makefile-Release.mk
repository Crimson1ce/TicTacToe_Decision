...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/InteligenciaArtificial.o \
	${OBJECTDIR}/Tablero.o \
...
${OBJECTDIR}/InteligenciaArtificial.o: InteligenciaArtificial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InteligenciaArtificial.o InteligenciaArtificial.cpp
